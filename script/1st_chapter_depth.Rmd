...
ggsave(paste0(folder_path, "/output/plots/new_submission_compressed/EDA_pca_bac.tiff"), pca.bac, compression = "lzw")
...
ggsave(paste0(folder_path,"/output/plots/new_submission_compressed/bar_plot_bac.tiff"),plot_bar ,
...
ggsave(paste0(folder_path, "/output/plots/new_submission_compressed/hclust_pca_south.tiff"), plot, 
...
ggsave(paste0(folder_path, "/output/plots/new_submission_compressed/boxplot_phylum_and_class.tiff"), box.plot, width = 10, height = 11.75, compression = "lzw")
```
...
ggsave(paste0(folder_path,"/output/plots/new_submission_compressed/RDA_bac.tiff"), p.rda, compression = "lzw")
...
vp <- varpart(Y, X1, X2)
tiff(paste0(folder_path,"/output/plots/new_submission_compressed/venndiagram_rda.tiff"), compression = "lzw")
...
ggsave(paste0(folder_path,"/output/plots/new_submission_compressed/mantel_bac_env.tiff"), mm, compression = "lzw")
```
...
ggsave(paste0(folder_path,"/output/plots/new_submission_compressed/aldex.phylum.tiff"),aldex.phylum, compression = "lzw")
```
...
ggsave(paste0(folder_path,"/output/plots/new_submission_compressed/aldex.class.tiff"),
...
ggsave(paste0(folder_path,"/output/plots/new_submission_compressed/aldex.phylum.class.tiff"),
...
ggsave(paste0(folder_path,"/output/plots/new_submission_compressed/aldex.family.tiff"),
       family.plots, 
       compression = "lzw", 
       height = 11.5, width = 9)
```
...
ggsave(paste0(folder_path,"/output/plots/new_submission_compressed/aldex.genus.tiff"),aldex.genus, compression = "lzw", width = 8, height = 6.5)
```
...
ggsave(paste0(folder_path,"/output/plots/new_submission_compressed/rf_stat_plot.tiff"),stat_rf_plot, compression = "lzw")
```
...
vImp.df <- read_csv("~/R/phd/2016/output/data/impvars_class_final.csv") %>%
  slice_max(Overall, n = 10)
...
ggsave(paste0(folder_path,"/output/plots/new_submission_compressed/rf_plots.tiff"), rf.plots, compression = 'lzw', width = 13, height = 7)
...
ggsave(paste0(folder_path,"/output/plots/new_submission_compressed/bar_plot_arc.tiff"),
       plots_to_save,
...
ggsave(paste0(folder_path,"/output/plots/new_submission_compressed/depth_profile_plot.tiff"), profile_plot,
       compression = "lzw")
```
...
ggsave(paste0(folder_path,"/output/plots/new_submission_compressed/RDA_arc.tiff"), p1,
       compression = "lzw")
```
...
tiff(filename = paste0(folder_path,"/output/plots/new_submission_compressed/heatmap_arc.tiff"), compression = "lzw", width = 15.8, height = 7.8, units = "in", res = 300)
ht
dev.off()
