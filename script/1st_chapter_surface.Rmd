...
ggsave(paste0(folder_path, "/output/plots/new_submission_compressed/pca_surf_bac.tiff"), pca.bac.surf, compression = "lzw")
...
ggsave(paste0(folder_path, "/output/plots/new_submission_compressed/pca_mantel_surf_bac.tiff"), plots, compression = "lzw", width = 9, height = 15)
